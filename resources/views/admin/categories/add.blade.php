              ...
              @csrf
                <div class="form m-3">
                    <div class="form-group">
                        ...
                        <input type="text" placeholder="Category Name" name="category_name" value="{{ old('category_name') }}" class="form-control col-md-4">
                        @error('category_name')
                    ...
                    <div class="form-group">
                        ...
                        <select name="parent_id" id="" class="form-control col-md-4">
                            <option selected disabled>Select root parent</option>
