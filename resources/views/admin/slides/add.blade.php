              ...
              @csrf
                <div class="form m-3">
                    <div class="form-group">
                        ...
                        <input type="text" placeholder="Slide name" name="slide_name" class="form-control col-md-4">
                    </div>
                    <div class="form-group">
                        <label for="">Description slide</label>
                        <input type="text" placeholder="description slide" name="desc_slide" class="form-control col-md-4">
                    </div>
                    <div class="form-group">
